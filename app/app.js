...
app.use(express.session({
  store : new RedisStore({host: '192.168.11.98', port: 6379}),
...
// browser sends the message 'connection'
// server receives the message and does what you want it to
var sockets = require('./lib/sockets');
var io = require('socket.io').listen(server, {log:true, 'log level':2});
// when server connects to app, call sockets.connection function
